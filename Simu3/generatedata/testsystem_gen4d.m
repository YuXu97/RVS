function [sys0, data] = testsystem_gen4d(T, par, repi)
% -- 4th order system
...
coef = [-0.694211849720806,0.972960566966661,-0.313813750856669,0.0528727106082454,-0.00474044909271643,0.000214381578085870,-3.84319261767320e-06];
ytrue = zeros(T,1);
for i = 1:7
